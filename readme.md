...
- 해외송금에서 요청 금액은 USD로 직접 입력합니다.
- 내부 FDS/한도 계산용 KRW 금액은 고정 환율 `1 USD = 1500 KRW`로 환산합니다.
- 환산식: `request_amount_krw = request_amount_usd * 1500`
...
- 해외 IP 접근 여부 질문은 `y/n`(및 yes/no 계열)만 허용합니다.
- 오타를 입력하면 안내 문구를 출력하고 재입력받습니다.
